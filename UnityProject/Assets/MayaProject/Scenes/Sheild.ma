...
//Name: Sheild.ma
//Last modified: Tue, Nov 25, 2025 07:32:28 PM
//Codeset: 1252
...
fileInfo "UUID" "C7DA8B47-47DD-DA20-BC26-33A6BB6454A1";
createNode transform -s -n "persp";
	rename -uid "E14934E7-44A9-DA03-E591-60B632B38DA4";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -4.9786468485072568 5.5783565202683016 -11.091226652228229 ;
	setAttr ".r" -type "double3" -18.938352733149955 -2675.7999999999756 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "AAA8FFC8-4C4B-6FF3-DC5C-04AF43617701";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 12.840392826449724;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "D1E9329A-4F20-1F0A-81A2-A487538897B4";
	setAttr -s 8 ".lnk";
	setAttr -s 8 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "92A78BA3-44D5-0F07-F4C9-9BB4CDC12F0E";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "ADD441B8-4B36-DD03-E7F1-768BFE9120CB";
createNode displayLayerManager -n "layerManager";
	rename -uid "A2400305-4592-ED8E-0A47-F8BC29B7BB28";
createNode displayLayer -n "defaultLayer";
	rename -uid "DD61E255-46FC-4065-3588-1D9B8460BB63";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "32DAE76A-4ADF-BE99-5D32-04B10DE6EF5C";

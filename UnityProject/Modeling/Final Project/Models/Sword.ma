...
//Name: Sword.ma
//Last modified: Fri, Dec 05, 2025 01:14:16 PM
//Codeset: 1252
...
fileInfo "UUID" "E286FE4A-4EAA-7FA5-3C29-19B01FB4611E";
createNode transform -s -n "persp";
	rename -uid "5B38F4E5-423C-E45C-C32B-9F884B0DBD50";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -12.629725834602208 6.8762758895736535 -4.7472018467962993 ;
	setAttr ".r" -type "double3" -12.938352728637909 1329.3999999990456 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "1CD1C38F-43A5-9AB2-6F0D-6287F5343CDD";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 13.843914340370747;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0 3.7765881259281269 0 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "AF8FBF92-4CBA-6431-09E0-B7A2A1E9F511";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "F0B5293D-4CC9-48BD-1903-4D8789953CC5";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "4266FBF0-4659-B7CC-8469-B0931D0CCC00";
createNode displayLayerManager -n "layerManager";
	rename -uid "44AE0F0D-4B67-0925-AFD9-2C81B62B545E";
createNode displayLayer -n "defaultLayer";
	rename -uid "0F0477BD-48BC-CF60-267D-5DA79E25F85B";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "10BC4377-4FBB-C90B-9B94-56B25466D942";
...
createNode polyTweak -n "polyTweak3";
	...
	setAttr ".uopa" yes;
	setAttr -s 25 ".tk";
	setAttr ".tk[192]" -type "float3" -0.030649394 -0.020171523 0 ;
	setAttr ".tk[193]" -type "float3" -0.024524311 -0.03495872 0 ;
	setAttr ".tk[194]" -type "float3" -0.030649394 0.020171523 0 ;
	setAttr ".tk[195]" -type "float3" -0.024524311 0.03495872 0 ;
	setAttr ".tk[196]" -type "float3" -0.0097370539 0.041083932 0 ;
	setAttr ".tk[197]" -type "float3" 0.0097370539 0.041083932 0 ;
	setAttr ".tk[198]" -type "float3" 0.024524311 0.03495872 0 ;
	setAttr ".tk[199]" -type "float3" 0.030649394 0.020171523 0 ;
	setAttr ".tk[200]" -type "float3" 0.030649394 -0.020171523 0 ;
	setAttr ".tk[201]" -type "float3" 0.024524311 -0.03495872 0 ;
	setAttr ".tk[202]" -type "float3" 0.0097370539 -0.041083932 0 ;
	setAttr ".tk[203]" -type "float3" -0.0097370539 -0.041083932 0 ;
...
createNode polyTweak -n "polyTweak6";
	...
	setAttr ".uopa" yes;
	setAttr -s 22 ".tk";
	setAttr ".tk[9]" -type "float3" 0 0 0.0078991186 ;
	setAttr ".tk[10]" -type "float3" 0 0 0.0078991186 ;
	setAttr ".tk[11]" -type "float3" 0 0 -0.0078991149 ;
	setAttr ".tk[12]" -type "float3" 0 0 -0.0078991149 ;
	setAttr ".tk[13]" -type "float3" 0 0 0.015803525 ;
	setAttr ".tk[14]" -type "float3" 0 0 0.015803525 ;
	setAttr ".tk[15]" -type "float3" 0 0 -0.015803525 ;
	setAttr ".tk[16]" -type "float3" 0 0 -0.015803525 ;
	setAttr ".tk[17]" -type "float3" 0 0 0.024831086 ;
	setAttr ".tk[18]" -type "float3" 0 0 0.024831086 ;
	setAttr ".tk[19]" -type "float3" 0 0 -0.024831086 ;
	setAttr ".tk[20]" -type "float3" 0 0 -0.024831086 ;
	setAttr ".tk[21]" -type "float3" 0 0 0.044005845 ;
	setAttr ".tk[22]" -type "float3" 0 0 0.044005845 ;
	setAttr ".tk[23]" -type "float3" 0 0 -0.044005845 ;
	setAttr ".tk[24]" -type "float3" 0 0 -0.044005845 ;
	setAttr ".tk[25]" -type "float3" 0 0 0.072211698 ;
	setAttr ".tk[26]" -type "float3" 0 0 0.072211698 ;
	setAttr ".tk[27]" -type "float3" 0 0 -0.072211698 ;
	setAttr ".tk[28]" -type "float3" 0 0 -0.072211698 ;
